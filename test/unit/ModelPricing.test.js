 ...
 * a later rate-table refresh can't silently revert that fix.
 */
...
describe('getRatesForModel', () => {
  it('returns Opus rates for any opus-flavored id', () => {
    for (const id of ['claude-opus-4-7', 'claude-opus-4-6', 'claude-opus-4-5-20250929', 'Claude Opus 4']) {
  ...
  it('returns Haiku rates for any haiku-flavored id', () => {
...
describe('priceConversation', () => {
  ...
  it('prices the same usage on Opus 4.7 at the Opus table (5x input)', () => {
